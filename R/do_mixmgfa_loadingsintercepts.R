#' @export
do_mixmgfa_loadingsintercepts <- function(data2,N_gs,nclust,nfactors,varlabels,grouplabels,maxiter = 5000,start = 1,nruns = 25,design=design,rotation=0,preselect=10,targetT=0,targetW=0,parcomp=0){
